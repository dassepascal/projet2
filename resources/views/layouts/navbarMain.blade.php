<!-- component -->
<nav id="main-nav" class="relative px-4 py-4 flex justify-between items-center bg-white dark:bg-gray-800 bg-red-500">
    ...
    <div class="lg:hidden bg-red-500">
    ...
    <ul id="menu-navbar" class="relative px-4 py-4 flex justify-between items-center bg-white dark:bg-gray-800 bg-red-500">
